...
@Component({
  selector: 'app-chapter-topics',
  templateUrl: './chapter-topics.component.html',
  styleUrls: ['./chapter-topics.component.scss'],
})
export class ChapterTopicsComponent implements OnInit {
 topicValue: any = '';
 topicsList: any = [];
